    ...
    extend: {
      colors: {
        ...
        pomodoro: {
          ...
          hover: "hsl(var(--pomodoro-hover))",
        },
        "break-short": {
          DEFAULT: "hsl(var(--break-short))",
          foreground: "hsl(var(--break-short-foreground))",
        },
        "break-long": {
          DEFAULT: "hsl(var(--break-long))",
          foreground: "hsl(var(--break-long-foreground))",
        },
        ...
        timer: {
          ...
          bg: "hsl(var(--timer-bg))",
          shadow: "hsl(var(--timer-shadow))",
        },
        
        /* Button specific */
        button: {
          shadow: "hsl(var(--button-shadow))",
